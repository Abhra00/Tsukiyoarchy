  ...
  config = function()
    local conf = {
      ...
      spec = {
        mode = { 'n', 'x' },
        { '<leader>', group = 'Leader' },
        { '<leader>/', group = 'Toggle Comments' },
        { '<leader>f', group = 'Find' },
        { '<leader>c', group = 'Code' },
        { '<leader>d', group = 'Debug' },
        { '<leader>e', group = 'Toggle Explorer' },
        { '<leader>sn', group = 'Noice' },
        { '<leader>gg', group = 'Git' },
        { '<leader>gD', group = 'Type Definition' },
        { '<leader>gs', group = 'Document Symbol' },
        { '<leader>ws', group = 'Workspace Symbol' },
        { '<leader>rn', group = 'Lsp Rename' },
        { '<leader>J', group = 'Java' },
        { '<leader>t', group = 'Tab' },
